...
export const Stop = (props: SVGProps<SVGSVGElement>) => {
  return (
    <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 19 19' {...props}>
      <path
        d='M19 5.52v7.96c0 .36-.02.71-.07 1.03-.04 0-.09-.02-.13-.03l-2.28-.76c-.02-.01-.03-.02-.05-.02v4.61c-.48.27-1.02.46-1.62.56.1-.18.16-.39.16-.62a1.336 1.336 0 0 0-2.67 0c0 .28.08.54.23.75H5.52C2.07 19 0 16.94 0 13.48V5.52C0 2.06 2.07 0 5.52 0h7.96C16.93 0 19 2.06 19 5.52Z'
        opacity={0.4}
      />
    </svg>
  )
