...
export const EmailVerificationTemplate = ({
  ...
  return (
    <Html>
      <Head />
      <Preview>
        Verify your email address to complete your Vishwas registration
      </Preview>
      <Body style={main}>
        <Container style={container}>
          <Section>
            <Text style={title}>Vishwas</Text>
            <Text style={text}>Hi,</Text>
            <Text style={text}>
              Thank you for registering for an account on Vishwas. To complete
